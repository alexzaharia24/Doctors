...
public class AddValidConsultation {
    ...
    public void initialize() {
        ...
        Consultation c1 = new Consultation("4", "1234567890123", "Flu", Collections.singletonList("Tea"), "10-04-2018");
        Consultation c2 = new Consultation("5", "2234567890123", "Flu", Collections.singletonList("Tea"), "25-04-2018");
    ...
    public void addConsultation() {
        ...
        Assert.assertEquals(consultations.size(), nrConsultations + 1);
